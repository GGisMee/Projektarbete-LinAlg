...
class MatrixTools:    
    ...
    @staticmethod
    def __permutate_collumns_by_keys(countries, permutation_key):
        permutated = []
        for country in countries:
            new_country = {}
            for key in permutation_key:
                if key in country:
